...
def main():
    values_path = input("Enter path to values.json: ")
    tests_path = input("Enter path to tests.json: ")
    reports_path = input("Enter save path to reports.json: ")
    ...
    print(f"File {reports_path} created succesfully!")
